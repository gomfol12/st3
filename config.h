 ...
 */
static char *font = "Inconsolata Nerd Font:pixelsize=28:antialias=true:autohint=true:dpi=192";
/* Spare fonts */
static char *font2[] = {
    "Symbols Nerd Font Mono:pixelsize=22:antialias=true:autohint=true:dpi=192",
    "Twemoji:pixelsize=22:antialias=true:autohint=true:dpi=192"
};
...
static char *openurlcmd[] = { "/bin/sh", "-c",
	"grep -o 'http[s]*://[^ ]*' | tr -d \"'\" | tr -d '\"' | dmenu -l 10 -w $WINDOWID | xargs -r linkhandler.sh",
	"externalpipe", NULL };
